...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleHeroNotFound(HeroNotFoundException ex) {
    ...
    @ExceptionHandler(BattleSimulationException.class)
    public ResponseEntity<Map<String, Object>> handleBattleSimulation(BattleSimulationException ex) {
        return buildError(HttpStatus.BAD_REQUEST, ex.getMessage());
    }
